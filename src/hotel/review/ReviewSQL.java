...
public class ReviewSQL {
	...
	public static final String REVIEW_SELECT_BY_ALL = "select r.review_no, r.review_date, r.review_title, r.review_content, u.user_id from review r join userinfo u on r.user_id = u.user_id order by r.review_no";
