...
public class InquiriesSQL {
	...
	public static final String INQUIRIES_SELECT_BY_NO = 
					"select i.inquiries_no, i.inquiries_title, i.inquiries_content, i.inquiries_date, u.user_id, u.user_name, u.user_email, u.user_tel from inquiries i join userinfo u  on i.user_id = u.user_id where i.inquiries_no = ?";
	public static final String INQUIRIES_SELECT_BY_ID = 
			"select * from inquiries i left outer join comments c on i.inquiries_no=c.inquiries_no where user_id=?";

	public static final String INQUIRIES_SELECT_BY_ALL = 
					"select * from inquiries i join userinfo u  on i.user_id = u.user_id left outer join comments c on c.inquiries_no=i.inquiries_no";
}
