...
public class InquiriesSQL {
	...
	public static final String INQUIRIES_SELECT_BY_NO = 
					"select i.inquiries_no, i.inquiries_title, i.inquiries_content, i.inquiries_date, u.user_id, u.user_email, u.user_tel, ic.comm_content, ic.comm_date from inquiries i join userinfo u  on i.user_id = u.user_id join comments ic on i.inquiries_no = ic.inquiries_no where i.inquiries_no = ?";
